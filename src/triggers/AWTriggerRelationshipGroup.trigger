/*****************************************************************************************
    Name             : AWTriggerRelationshipGroup 
...
Sumeet Kanjilal                  3/19/2015           Modified for code re-factoring & optimization
******************************************************************************************/
trigger AWTriggerRelationshipGroup on Relationship_Group__c (after delete, after insert, after undelete, after update, before insert, before update) {
    ...
    String ObjectName = 'Relationship_Group__c';
